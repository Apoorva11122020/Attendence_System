...
class Face_Recognition:
    def __init__(self,root):
        ...
        title_lbl=Label(self.root,text="Face Recognition",font=("times new roman",35,"bold"),bg="blueviolet",fg="white")
        title_lbl.place(x=0,y=0,width=1530,height=60)
        
        #1st image
        img_top=Image.open(r"images\b9.png")
        ...
        #2nd image
        img_bottom=Image.open(r"images\b10.jpg")
        ...
        b1_1=Button(f_lbl,text="Face Recognition",command=self.face_recogg,cursor="hand2",font=("times new roman",18 ,"bold"),bg="blueviolet",fg="white")
