...
class Attendence:
    def __init__(self,root):
        ...
        #first image
        img1=Image.open(r"images\b13.jpg")
        ...
        img2=Image.open(r"images\b14.jpg")
        ...
        img3=Image.open(r"images\b15.png")
        ...
        title_lbl=Label(bg_img,text="ATTENDENCE MANAGEMENT SYSTEM",font=("times new roman",35,"bold"),bg="blueviolet",fg="white")
        title_lbl.place(x=0,y=-1.5,width=1530,height=58)
        
        main_frame=Frame(bg_img,bd=2,bg="white")
        main_frame.place(x=55,y=55,width=1380,height=450)
        
        #left label frame
        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Attendence Details",font=("lato",12,"bold"))
        Left_frame.place(x=10,y=10,width=660,height=420)
        
        left_inside_frame=Frame(Left_frame,bd=2,relief=RIDGE,bg="white")
        left_inside_frame.place(x=4,y=5,width=640,height=350)
        ...
        save_btn=Button(btn_frame,text="Import csv",command=self.importCsv,width=15,font=("lato",13,"bold"),bg="blueviolet",fg="white")
        save_btn.grid(row=0,column=0)
        
        update_btn=Button(btn_frame,text="Export csv",command=self.exportCSV,width=15,font=("lato",13,"bold"),bg="blueviolet",fg="white")
        update_btn.grid(row=0,column=1)
        
        update_btn=Button(btn_frame,text="Update",width=15,font=("lato",13,"bold"),bg="blueviolet",fg="white")
        update_btn.grid(row=0,column=2) 
        
        reset_btn=Button(btn_frame,text="Reset",command=self.reset_data,width=15,font=("lato",13,"bold"),bg="blueviolet",fg="white")
        reset_btn.grid(row=0,column=3) 
        
         #right label frame
        Right_frame=LabelFrame(main_frame,bd=2,relief=RIDGE,text="Attendence Details",font=("lato",12,"bold"))
        Right_frame.place(x=680,y=10,width=660,height=420)
        
        table_frame=Frame(Right_frame,bd=2,relief=RIDGE)
        table_frame.place(x=5,y=5,width=640,height=380)
